        ...
        <View style={estiloItem.container}>
            ...
            <View style={estiloItem.header}>
                <TouchableOpacity onPress={voltar}>
                    <MaterialIcons name="arrow-back" size={24} color="white"></MaterialIcons>
                </TouchableOpacity>
            ...
            <View style={estiloItem.formularioContainer}>
                ...
                <View style={estiloItem.campoContainer}>
                    ...
                    <TextInput 
                        ...
                        placeholder="Titulo"
                        placeholderTextoColor='FFFFFF'
                        onChandeText={titulo => setItem({...item, titulo})}
                        value={item.titulo}
                    />
                </View>
                ...
                <View style={estiloItem.campoContainer}>
                    ...
                    <TextInput 
                        ...
                        placeholder="Autor"
                        placeholderTextoColor='FFFFFF'
                        onChandeText={autor => setItem({...item, autor})}
                        value={item.autor}
                    />
                </View>
                ...
                <View style={estiloItem.campoContainer}>
                    ...
                    <TextInput 
                        ...
                        maxLength={4}
                        onChandeText={anoPublicacao => setItem({...item, anoPublicacao})}
                ...
                <View style={estiloItem.campoContainer}>
                    ...
                    <TextInput 
                        ...
                        numberOfLines={4}
                        blurOnSubmit={false}
                        onChandeText={descricao => setItem({...item, descricao})}
